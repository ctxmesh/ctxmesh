...
func UnmarshalFixture(data []byte) (*Fixture, error) {
	...
	if f.SchemaVersion > SchemaVersion {
		return nil, fmt.Errorf("replay: fixture schemaVersion %d is newer than supported version %d — upgrade agent-engine to replay it", f.SchemaVersion, SchemaVersion)
	}
	return &f, nil
}

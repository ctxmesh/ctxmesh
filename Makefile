...
.PHONY: comment-budget
comment-budget: ## Assert no comment block exceeds the budget outside api/ (M158). Static.
	./hack/comment-budget.sh

.PHONY: flow-completability
flow-completability: ## Assert every caller-scoped BFF write is completable by a shipped role (M155). Static.
	./hack/flow-completability.sh

...
const AUDIT: AuditListResponse = {
  items: [
    ...
    { id: 88_213, occurredAt: "2026-08-31T09:38:02Z", source: "controller", actor: "system:serviceaccount:agentry:controller", actorKind: "controller", action: "tool.bind", resourceKind: "MCPToolBinding", resourceName: "acme-crm-refund", namespace: NS_DEFAULT, outcome: "denied", detail: { reason: "ToolApprovalRequired" } },
    ...
    { id: 88_210, occurredAt: "2026-08-30T22:14:07Z", source: "controller", actor: "system:serviceaccount:agentry:controller", actorKind: "controller", action: "kb.ingest", resourceKind: "KnowledgeBase", resourceName: "demo-kb", namespace: NS_DEFAULT, outcome: "success", detail: { documents: 96, chunks: 4182 } },
    ...
    { id: 88_206, occurredAt: "2026-08-30T11:48:22Z", source: "controller", actor: "system:serviceaccount:agentry:controller", actorKind: "controller", action: "agent.reconcile", resourceKind: "AgentDeployment", resourceName: "billing-agent", namespace: NS_B, outcome: "error", detail: { reason: "OOMKilled", exitCode: 137 } },
    ...
    { id: 88_203, occurredAt: "2026-08-29T12:00:31Z", source: "controller", actor: "system:serviceaccount:agentry:controller", actorKind: "controller", action: "guardrail.block", resourceKind: "GuardrailPolicy", resourceName: "pii-and-jailbreak", namespace: NS_DEFAULT, outcome: "denied", traceId: "trace-6", detail: { detector: "jailbreak", score: 0.97 } },
  ],
  nextCursor: "ODgyMDM",
};
